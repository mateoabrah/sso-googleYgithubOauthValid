<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Modifica la teva contrasenya') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __('Per la teva seguretat, utilitza una contrasenya llarga i aleatòria.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirmar nova contrasenya')" />
